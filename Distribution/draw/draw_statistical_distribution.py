...
methods= {
        ...
        "LabelPropagation":{
            "symbol": "^-",
            "color": "#F4C20D",
            "reveal": "LabelPropagation"
        },
        "LabelSpreading":{
            "symbol": "D-",
            "color": "#911EB4",
            "reveal": "LabelSpreading"
        },
        # "Co_Training": {
        #     "symbol": "8-",
        #     "color": "#46F0F0",
...
g=open('./Distribution/'+'statistical_tabular'+str(labels)+'_stat.csv', "w",encoding="utf-8")
...
for dataset in datasets:
    f = open("./Distribution/"+dataset+"_statistical_distribution_labels_"+str(labels)+'.csv', "r",encoding="utf-8")
    f_read=csv.reader(f)
    dict_mean={}
    dict_std={}
    for row in f_read:
    ...
    # max_mean=0
    # min_mean=100
    max_mean=min(dict_mean['XGBoost' +'0']+0.1,1)
    min_mean=max(dict_mean['XGBoost' +'0']-0.1,0)
    ...
    axes[j].set_xlabel("Data Distribution Inconsistency t", fontdict={"size": 8})
    ...
    pos+=1
plt.tight_layout()
plt.savefig('Distribution_statistical_'+'tabular'+'_labels_'+str(labels)+'.eps',dpi=300)
plt.savefig('Distribution_statistical_'+'tabular'+'_labels_'+str(labels)+'.png',dpi=300)
plt.show()
